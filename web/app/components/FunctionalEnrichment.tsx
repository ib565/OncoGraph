...
type FunctionalEnrichmentProps = {
...
export default function FunctionalEnrichment({ onNavigateToQuery }: FunctionalEnrichmentProps = {}) {
  ...
  const buildEnrichmentCsv = useCallback(
    (source: PartialEnrichmentResult | EnrichmentResponse, sourceLabel: string) => {
      ...
      const metadataLines = [
        ["# Export Type", "Functional Enrichment"],
        ["# Source", sourceLabel],
  ...
  return (
    <div className="bench-panel">
      <div className="panel-header">
        <h3 className="panel-title">Functional Enrichment</h3>
      </div>
